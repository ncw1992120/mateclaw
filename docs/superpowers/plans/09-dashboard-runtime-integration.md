...
**2026-09-15 图表多 Tab 运行时验收 fixture：** 在 `dataset-management-entry.spec.ts` 增加临时图表多 Tab 看板，真实 E2E 将验证预览 Tab 的 ArrowRight 焦点和选中态，并在 finally 中清理看板；正式执行需注入真实 E2E Token/工作区变量。
