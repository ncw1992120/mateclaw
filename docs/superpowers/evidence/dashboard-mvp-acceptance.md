...
### 2026-09-15 问数执行计划与委派节点键盘语义修复

- 问题：问数执行计划折叠栏、可展开步骤和委派调用树使用可点击 `div`，键盘无法触发展开/收起。
...
### 2026-09-15 工作空间二级菜单键盘语义修复

- 问题：工作空间二级菜单使用无 `href` 的 `<a>` 和点击处理，无法通过键盘选择成员、授权或定时任务等分类。
...
### 2026-09-15 双源快照差异容错与浏览抽屉 Tab 语义补充
