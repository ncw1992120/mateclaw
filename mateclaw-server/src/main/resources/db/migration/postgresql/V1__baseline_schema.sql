...
CREATE UNIQUE INDEX IF NOT EXISTS uk_mate_user_username ON mate_user (username);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_mate_system_setting_setting_key ON mate_system_setting (setting_key);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_mate_conversation_conversation_id ON mate_conversation (conversation_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_mate_channel_session_conversation_id ON mate_channel_session (conversation_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_mate_tool_approval_pending_id ON mate_tool_approval (pending_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_mate_tool_guard_rule_rule_id ON mate_tool_guard_rule (rule_id);
