...
INSERT INTO mate_wiki_transformation (id, kb_id, workspace_id, name, title, description, prompt_template, apply_default, model_id, enabled, output_target, create_time, update_time, deleted)
VALUES
...
合同正文：
{input_text}', FALSE, NULL, TRUE, 'page', LOCALTIMESTAMP(3), LOCALTIMESTAMP(3), 0),
