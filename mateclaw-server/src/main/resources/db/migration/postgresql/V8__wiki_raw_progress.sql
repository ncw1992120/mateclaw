...
ALTER TABLE mate_wiki_raw_material ADD COLUMN IF NOT EXISTS progress_total INTEGER DEFAULT 0;

ALTER TABLE mate_wiki_raw_material ADD COLUMN IF NOT EXISTS progress_done INTEGER DEFAULT 0;
