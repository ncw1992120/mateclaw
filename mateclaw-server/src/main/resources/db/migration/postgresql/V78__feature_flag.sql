...
DROP TRIGGER IF EXISTS trg_mate_feature_flag_upd_ts ON mate_feature_flag;
CREATE TRIGGER trg_mate_feature_flag_upd_ts BEFORE UPDATE ON mate_feature_flag
    FOR EACH ROW EXECUTE FUNCTION set_update_time();

INSERT INTO mate_feature_flag (flag_key, enabled, description)
VALUES
