<template>
  <header class="top-nav">
    ...
    <div class="nav-right">
      <button class="nav-btn icon-btn notification-btn" :title="t('nav.notification')" :aria-label="t('nav.notification')">
      ...
      <el-dropdown trigger="click" popper-class="topnav-dropdown-popper" @command="handleThemeCommand">
        <button class="nav-btn icon-btn theme-btn" :title="t('theme.title')" :aria-label="t('theme.title')">
