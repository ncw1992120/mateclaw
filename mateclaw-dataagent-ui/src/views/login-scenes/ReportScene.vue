  ...
  <div class="report-scene">
    <div class="report-card">
      <div class="report-cover">
        ...
        <h3 class="cover-title">月度经营分析</h3>
        <p class="cover-date">2026 年 6 月</p>
      </div>
